...
%default tilesize = 30;    % the size of the tiles we paste down (assumed square)
tilesize = 30;
%default overlap = 5
...
figure,imshow(sampleI); axis image;  title('image');
figure,imshow(output_quilt); axis image;  title('synthesized, quilted');
